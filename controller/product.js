...
const { Product, Review, Purchase } = db;
...
cloudinary.config({
	...
	const create = async (req, res) => {
		try {
			...
			const {title, price, discount, description, color, size, imageUrl } = req.body;
	...
	const update = async (req, res) => {
		try {
			const { title, price, discount, description, color, size, categoryId } = req.body;
